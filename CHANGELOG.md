...
- Isolated the test suite from developer `.env` whitelist leakage via an autouse fixture in `tests/conftest.py`, preventing local environment variables from affecting test outcomes.
